...
// Export ABI map for protocols
export const PROTOCOL_ABIS = {
  Aave: AAVE_POOL_ABI,
  Compound: COMPOUND_COMET_ABI,
  Yearn: YEARN_VAULT_ABI,
  Curve: YEARN_VAULT_ABI, // Simplified, use similar interface
  Beefy: YEARN_VAULT_ABI, // Simplified, use similar interface
} as const;
